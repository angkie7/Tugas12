...
public class RecyclerViewDaftarMahasiswa extends AppCompatActivity {
    ...
    private void tambahData(){
        ...
        mhsList.add(new Mahasiswa("72170146","Angkie","angkie.octovaldo@si.ukdw.ac.id","Balikpapan",R.drawable.logoku));
        mhsList.add(new Mahasiswa("72170148","Dorra","christian.dorra@si.ukdw.ac.id","Pontianak",R.drawable.logoku));
        mhsList.add(new Mahasiswa("72170136","Ekki","ekki.saragih@si.ukdw.ac.id","Yogyakarta",R.drawable.logoku));
    }
}
